...
class Analyzer(object):
    def __init__(self,ID,runningTime,activationFile):
        ...
        self.db = MySQLdb.connect("10.0.0.3", "root", "Finelab123...", "new_injection", charset="utf8")
...
#             print(value)
        ...
        insertTemp="insert into injection_record_flink(%s) values(%s)" % (tableColumns, valueTml)
