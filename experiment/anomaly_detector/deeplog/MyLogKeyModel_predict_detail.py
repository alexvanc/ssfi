                    ...
                    if tfile.endswith(".sequence2"):
                        with open(os.path.join(dirpath,tfile),'r') as f:
                            for line in f.readlines():
                                ...
                                oneJobData.append(tmplSequence)
...
if __name__ == '__main__':
    ...
    model_path='{}/{}_adam_batch_size={}_epoch={}.pt{}'.format(model_dir,model_dir, str(batch_size), str(num_epochs),str(train_size))
