...
public class ExceptionUncaughtTransformer extends BodyTransformer {
	...
	private boolean injectTryUncaught(Body b) {
		// TODO Auto-generated method stub
		Chain<Unit> units = b.getUnits();
...
//          tmpTrap.get
			...
			// Directly throw a new Exception
			...
			AssignStmt assignStmt = Jimple.v().newAssignStmt(lexception, Jimple.v().newNewExpr(RefType.v(rootExceptionClass)));
...
//			units.insertBefore(gotoStmt, sUnit);
	...
	private boolean injectThrowUncaught(Body b) {
		// TODO Auto-generated method stub		
		//this is the only difference compared to ExceptionShortFault
		SootClass exception = Scene.v().getSootClass("java.lang.Exception");
		// Find the constructor of this Exception
		SootMethod constructor = null;
